...
Adicionalmente, los datos de la analítica de sangre los quiero en formato JSON. Asegúrate de que el JSON sea válido y esté claramente estructurado. Si falta un valor en el análisis, le pones null; excepto a los códigos LOINC que ya están predeterminados en la estructura y nunca los pongas null a los predeterminados. No cambies los nombres de los valores predeterminados, por ejemplo, Leucocitos (recuento) es igual a Leucocitos y así con el resto de los valores. No cambies los nombres normalizados, ya te los he dejado predeterminados. El JSON debe seguir esta estructura:
{
  "paciente": {
    "dni": "string",
    "nombre": "string",
...
const jaramilloPrompt =
  "Analiza esta analítica de sangre aplicando criterios similares a los del Dr. Carlos Jaramillo, que es un médico funcional colombiano, experto en metabolismo, nutrición y bioquímica.";
