...
Asegúrate de que el JSON sea válido y esté claramente estructurado. Si falta un valor en el análisis, le pones null; excepto a los codigos LOINC que ya están predeterminados en la estructura y nunca los pongas null a los predeterminados. Igual con el rango de referencia, si no encuentras en la analitica un rango de referencia, deja el predeterminado.

El texto de tu analisis en lenguaje natural en Markdown puede preceder o seguir al bloque JSON, pero el JSON debe estar claramente delimitado para facilitar su extracción y procesamiento. En el campo "resumen" elabora un resumen de la analítica en lenguaje natural de no mas de 200 palabras.
