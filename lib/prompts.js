...
Adicionalmente, los datos de la analítica de sangre los quiero en formato JSON. Asegúrate de que el JSON sea válido y esté claramente estructurado. Si falta un valor en el análisis, le pones null; excepto a los códigos LOINC que ya están predeterminados en la estructura y nunca los pongas null a los predeterminados. Igual con el rango de referencia, si no encuentras en la analitica un rango de referencia, deja el predeterminado.  No cambies los nombres de los valores predeterminados, por ejemplo, Leucocitos (recuento) es igual a Leucocitos y así con el resto de los valores. En el campo "resumen" elabora un resumen de la analítica en lenguaje natural de no mas de 200 palabras. Finalmente, el JSON debe seguir esta estructura:
{
  "paciente": {
