...
Adicionalmente, los datos de la analítica de sangre los quiero en formato JSON. Asegúrate de que el JSON sea válido y esté claramente estructurado. Si falta un valor en el análisis, le pones null; excepto a los códigos LOINC que ya están predeterminados en la estructura y nunca los pongas null a los predeterminados. No cambies los nombres de los valores predeterminados, por ejemplo, Leucocitos (recuento) es igual a Leucocitos y así con el resto de los valores. No cambies los nombres normalizados, ya te los he dejado predeterminados. Si la analítica no tiene el Colesterol no HDL, calculalo restando el Colesterol Total menos el HDL. Utiliza las unidades que tiene la estructura del JSON, y si hay discrepancia, haz la conversion. El JSON debe seguir esta estructura:
{
  "paciente": {
    "dni": "string",
    "nombre": "string",
